...
exports.myOrders = asyncHandler(async (req, res) => {
  ...
  const { documents: orders, pagination } = await paginate(Order.find(filter).populate(customerOrderPopulate).sort("-createdAt"), Order.countDocuments(filter), req.query);
